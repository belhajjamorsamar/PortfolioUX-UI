...
const projects = [
  {
    ...
    year: "2025",
    type: "Redesign",
    description: "Complete UI/UX overhaul to enhance user interface and experience. Analyzed existing friction points, created high-fidelity wireframes, and implemented front-end improvements following best UX/UI practices with user testing iterations.",
    image: "/1.png",
    color: "#EC4899",
    category: "Redesign",
  ...
  },
  {
    ...
    year: "2025",
    type: "Mobile App",
    description: "An educational app designed for 10-year-old children to learn French. Created an engaging, age-appropriate interface that makes language learning fun and interactive.",
    image: "/5.png",
    color: "#A78BFA",
  ...
  },
  {
    ...
    year: "2025",
    type: "Web Design",
    description: "Design for a UI/UX agency website showcasing services, portfolio, and expertise in user experience and interface design.",
    image: "/33.png",
    color: "#FB7185",
    category: "Web Design",
    // pas encore de lien
  },
  {
    ...
    year: "2024",
    type: "Mobile App",
    description: "Redefining event discovery with an app that allows users to explore upcoming events, search artists, filter events, view detailed information, and purchase tickets. Focus on visually captivating and functional UI with advanced design techniques.",
    image: "/44.png",
    color: "#38BDF8",
    category: "Mobile Apps",
  ...
  },
  {
    ...
    year: "2025",
    type: "Platform",
    description: "Platform connecting charitable associations with volunteers and donors. Features include event listings, donation management, member enrollment, and organization dashboards. Includes Home, Associations, Events, Donate, Get Involved, Resources pages, user authentication, and admin interfaces.",
    image: "/55.png",
    color: "#FDBA74",
    category: "Platforms",
  },
  {
    ...
    year: "2024",
    type: "Enterprise",
    description: "Developed a real-time stock management system for an industrial robot. Features include dashboard with alerts, stock levels, inventory movements, and integrated e-commerce website synchronized with physical inventory. Conducted field testing and synchronization optimization.",
    image: "/66.png",
    color: "#EC4899",
